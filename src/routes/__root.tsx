  ...
  head: () => ({
    meta: [
      ...
      { title: "Sono & Doomscrolling · Dashboard Analítico" },
      {
        name: "description",
        content:
          "Dashboard interativo sobre hábitos de sono e doomscrolling noturno em 1.000 respondentes.",
      },
      { property: "og:title", content: "Sono & Doomscrolling · Dashboard Analítico" },
      {
        property: "og:description",
        content:
          "KPIs, correlações e filtros interativos sobre telas antes de dormir e qualidade do sono.",
      },
